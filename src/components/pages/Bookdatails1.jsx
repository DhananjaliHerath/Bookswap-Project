...
export default function Bookdatails1() {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://ichef.bbci.co.uk/news/976/cpsprodpb/E937/production/_119630795_hpbook976.jpg"/>
