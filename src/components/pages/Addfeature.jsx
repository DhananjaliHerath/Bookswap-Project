              ...
              <div className="border-0 rounded-lg shadow-lg relative max-w-[700px] px-3  w-full bg-white outline-none focus:outline-none " 
                ...
                <div className="flex  flex-col justify-between p-5 mb-3 ">
                  ...
                  <div className='flex space-x-3 mr-4 mt-10'  >
                    <div className=' w-1/2 '>
                        <label for="email" class="block mb-2 w-96 text-sm mt-2 font-medium text-gray-900 dark:text-gray-300 ">Featured</label>
                        <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="featured"  onChange={(e) => setFeatured(e.target.value)}/>
